...
public class BookGetter extends Service {
    ...
    private void getHtml(Context context, PlatformItem platformItem, String bookName, String bookCode) {
        ...
        String url = (bookCode != null)?
                platformItem.getPlatformUrl() + bookCode :
                platformItem.getSearchPath() + bookName;
        Log.d("url", url);
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                ...
                if (bookCode == null) {
                    ...
                    sendMessage(platformItem.getID(), bookList);
                } else {
                    List<BookItem> bookList = htmlToBookList(platformItem, htmlContent);
                    sendMessage(platformItem.getID(), bookList);
                }
...
//        Log.d(Tag, "htmlContent:" + htmlContent);
    ...
    private void sendMessage(int platformID, List<BookItem> bookList) {
