...
//                    }
     ...
     * @param bookCode 书籍编号
     */
    private void getHtml(Context context, PlatformItem platformItem, String bookCode, boolean isCreate) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                ...
                sendMessage(platformItem.getID(), bookItem);
            }
            @Override
...
//        Log.d(Tag, "htmlContent:" + htmlContent);
        ...
        if (htmlContent.contains(infoError) || htmlContent.equals("0")) {
            ...
            try {
                ...
                if (infoFormatJson == null) return null;
                Document doc = Jsoup.parseBodyFragment(htmlContent);

                JSONArray findList = infoFormatJson.getJSONArray("infoList");
                Elements infoAttrs = Filter.switchActionToElements(findList, doc);
                if (infoAttrs != null) {
                    for (Element infoAttr : infoAttrs) {
    ...
    private void sendMessage(int platformID, BookItem bookItem) {
        ...
        LocalFragment.handler_info.sendMessage(msg);
    }
